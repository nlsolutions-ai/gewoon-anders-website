...
export const Route = createFileRoute("/welkom-kort")({
  head: () => ({
    meta: [
      { title: "Welkom bij Gewoon Anders Ondernemen Kort" },
      {
        name: "description",
        content:
          "Bedankt voor je aankoop van Gewoon Anders Ondernemen Kort. Plan hier je eerste sessie en lees wat er nu gaat gebeuren.",
      },
...
// Eerste sessie van de korte variant gebruikt dezelfde sessie-kanalen.
...
const watNu = [
  ...
  {
    h: "Je eerste sessie",
    p: "Hieronder kun je sessie één meteen inplannen. Een rustig gesprek waarin we de vraag waar je voor komt scherp maken en kijken hoe we 'm in vier sessies aanpakken.",
  },
  {
    h: "Een korte voorbereiding per mail",
    p: "Uiterlijk drie dagen voor je eerste sessie krijg je van mij een paar vragen toegestuurd. Niet om huiswerk te zijn, wel om de afgebakende vraag waar je voor komt alvast helder te krijgen.",
  },
];

function WelkomKortPage() {
  return (
    <>
      <PageHeader
        eyebrow="Welkom · je bent ingestapt"
        title="Mooi dat je er bent."
        intro="Je hebt zojuist Gewoon Anders Ondernemen Kort geboekt. Hieronder lees je rustig wat er nu gaat gebeuren, en kun je direct je eerste sessie inplannen op het kanaal dat voor jou werkt."
      />
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-2 text-[15px] leading-relaxed text-foreground/75">
                  De verkorte variant van vier sessies staat klaar. Geen haast —
                  plan je eerste sessie wanneer dat past, deze week of volgende.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="bg-secondary">
        <div className="mx-auto max-w-5xl px-6 py-16 lg:px-10 lg:py-20">
          <FadeIn>
            <span className="eyebrow">Sessie 1 · Kennismaking en je vraag</span>
            <h2 className="display-lg mt-5 text-3xl sm:text-[2rem]">
            ...
            <p className="mt-5 max-w-2xl text-[17px] leading-relaxed text-foreground/75">
              ...
              kanaal dat jij kiest en maken samen de vraag scherp waar je voor
              komt. Je hoeft niets voor te bereiden.
            </p>
          </FadeIn>
