        ...
        <div className="relative mx-auto grid max-w-[1240px] gap-10 px-6 pb-16 pt-12 lg:grid-cols-12 lg:gap-14 lg:px-10 lg:pb-24 lg:pt-20">
          <div className="lg:col-span-7 lg:pr-4">
            ...
            <Reveal delay={140}>
              <p className="mt-7 max-w-xl text-[17px] leading-relaxed text-foreground/75 lg:text-[18px]">
                Je hebt zojuist Gewoon Anders Ondernemen Kort geboekt. Hieronder
                lees je rustig wat er nu gaat gebeuren, en kun je direct je
                eerste sessie inplannen op het kanaal dat voor jou werkt.
              </p>
            </Reveal>
          </div>
          ...
          <div className="lg:col-span-5">
            <Reveal variant="right" delay={120}>
              <img
                src={mockupKort}
                alt="Gewoon Anders Ondernemen Kort: vier sessies, werkboek en routekaart"
